package com.lynnpadc.customeviewassignment.views.components
...
class CustomStraightProgressBar @JvmOverloads constructor(
    ...
    private var availableColor = context.let { ContextCompat.getColor(it, R.color.colorAccent) } ?: 0
    private var unavailableColor = context.let { ContextCompat.getColor(it,R.color.colorPrimaryLight) } ?: 0
